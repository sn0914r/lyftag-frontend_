...
const TERMS_PARAGRAPHS = [
  `These Terms and Conditions, along with privacy policy or other terms ("Terms") constitute a binding agreement by and between SANJAY KUMAR JUTTUGA, ("Website Owner" or "we" or "us" or "our") and you ("you" or "your") and relate to your use of our website, goods (as applicable) or services (as applicable) (collectively, "Services").`,
  ...
  `All disputes arising out of or in connection with these Terms shall be subject to the exclusive jurisdiction of the courts in Visakhapatnam, Andhra Pradesh.`,
    ...
    <PageWrapper>
      <PageContainer>
        ...
        <PageHeader>
          ...
          <PageMeta>
            Last updated: January 2026 &nbsp;·&nbsp; LYF TAG, India
          </PageMeta>
        </PageHeader>

        <PolicySection>
          {TERMS_PARAGRAPHS.map((text, i) => (
            <PolicyParagraph key={i}>{text}</PolicyParagraph>
          ))}
        </PolicySection>
      </PageContainer>
    </PageWrapper>
